...
export class LayoutComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        //         this.config.layout = user.preferences.layout;
        //         this.config.scheme = user.preferences.dark ? 'dark' : 'light';
        //         this.config.theme = user.preferences.theme;
        //     }
        // });
        ...
        combineLatest([
            ...
            // this.userService.user$.subscribe(user => {
            //     if (user && user.preferences) {
            //         this.scheme = user.preferences.dark ? 'dark' : 'light';
