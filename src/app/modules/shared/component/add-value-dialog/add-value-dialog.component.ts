...
import { ProductCategoryService } from 'app/modules/admin/product-category/product-category.service';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, SharedMaterialModules, ReactiveFormsModule, RvAutoCompleteComponent],
