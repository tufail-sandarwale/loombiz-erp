...
// import { EmployeePermissionService } from 'app/core/auth/guards/employee.guards';
...
export class EmployeeListComponent implements OnInit {
  ...
  add() {
    this.router.navigate(['/masters/employee/add']);
  }

  edit(element) {
    this.router.navigate(['/masters/employee/edit', element.id]);
  }
